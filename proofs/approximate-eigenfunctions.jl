...
# ╔═╡ 395623fc-6baf-11eb-29d5-979c107cc16d
md"The domain is parametrised by three values `N`, `d` and `h`. The version in the article uses"

# ╔═╡ 591d9870-6baf-11eb-237e-a104e89dc7f6
N, d, h = 27, 11, 6

# ╔═╡ c2c6e4d2-6a26-11eb-2b0c-31de8f876374
md"We start by defining the eigenfunctions four eigenfunctions we will use. Both $u_1$ and $u_2$ have a six-fold even symmetry, which we get by giving `symmetry_class = 1`. $u_3$ and $u_4$ have similar but slighly different symmetries, which we get with `symmetry_class = 2` and `symmetry_class = 3` respectively."
...
λs = [31.0432, 63.2104, 63.7259, 63.7259]
